...
async def add_to_queue(user_id: int) -> Optional[Dict]:
    ...
    # Try to create match using Redis transaction for atomicity
        ...
        try:
            ...
            if queue_length >= 2:
                ...
                if len(results) >= 2 and results[0] and results[1]:
                    ...
                    # Validate both players are still alive
                    ...
                    # Return match info for current user if they're one of the matched players
                    ...
                    # If current user wasn't in this match, return None (they'll try again)
                    return None
