...
def calculate_new_rating(current_rating: float, expected_score: float, actual_score: float) -> float:
...
async def update_elo_ratings(db: Session, winner_id: int, loser_id: int, is_draw: bool = False):
    ...
    winner_new_rating = calculate_new_rating(winner_rating, winner_expected, winner_actual)
